<template>
  ...
  <div class="text-white">
    <div class="flex flex-row justify-between">
      ...
      <div class="text-yellow-300 font-bold text-1xl">Vue js Music App</div>
    </div>
    <div>
      <img class="rounded mt-8 mb-5" v-bind:src="song.src" />
    ...
    <div class="grid grid-cols-3 mt-10">
      ...
      <div class="flex items-center justify-center">
        <button
          class="rounded-full bg-yellow-300 h-24 w-24 font-bold text-black"
